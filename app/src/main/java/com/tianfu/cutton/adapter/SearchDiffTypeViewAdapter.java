...
import com.tianfu.cutton.model.SearchBean;
 ...
 * adapter
 */
public class SearchDiffTypeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final Context context;
    private List<SearchTestbean.ValueBean.RowsBean> mData;
    ...
    public SearchDiffTypeViewAdapter(Context context, List<SearchTestbean.ValueBean.RowsBean> data) {
    ...
    private void setOneType(final TypeOneViewHolder holder, final int position) {
        final SearchTestbean.ValueBean.RowsBean itemModel = mData.get(position);
        ...
        if (itemModel.breakLoadAverage != null && !"".equals(itemModel.breakLoadAverage)) {
            ...
            if (Double.parseDouble(itemModel.breakLoadAverage) >= 28) {
     ...
     /*   if (itemModel.distance != null&&!"".equals(itemModel.distance)) {
        ...
        String[] split = itemModel.updateTime.split(" ");
        if (itemModel.updateTime != null && !"".equals(itemModel.updateTime)) {
            holder.tv_store_date.setText(split[0]);
        } else {
    ...
    public void removeData(SearchBean.ValueBean.RowsBean itemModel) {
    ...
    public SearchTestbean.ValueBean.RowsBean getItem(int pos) {
