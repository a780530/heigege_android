 ...
 * adapter
 */
public class QualityTypeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final Context context;
    private List<QualityBean.ValueBean.RowsBean> mData;
    ...
    public QualityTypeViewAdapter(Context context, List<QualityBean.ValueBean.RowsBean> data) {
    ...
    private void setOneType(final TypeOneViewHolder holder, final int position) {
        ...
        final QualityBean.ValueBean.RowsBean itemModel = mData.get(position);
        ...
        holder.cbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               boolean flag = false;
                for (QualityBean.ValueBean.RowsBean bean : mData) {
                    if (bean.isSelect) {
                        flag = true;
                        break;
                    }
    ...
    public void removeData(QualityBean.ValueBean.RowsBean itemModel) {
    ...
    public QualityBean.ValueBean.RowsBean getItem(int pos) {
