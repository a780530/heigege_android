...
public class HomePurchaseDetailsActivity extends AppCompatActivity {
    ...
    private void initData(PurchaseDynamicsBean.ValueBean rowsBean) {
        ...
        id = rowsBean.id;
        PurchaseDynamicsBean.ValueBean.BreakLoadAverageBean breakLoadAverage1 = rowsBean.breakLoadAverage;
        PurchaseDynamicsBean.ValueBean.LengthAverageBean lengthAverage = rowsBean.lengthAverage;
        PurchaseDynamicsBean.ValueBean.MicronAverageBean micronAverage = rowsBean.micronAverage;
