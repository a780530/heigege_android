...
public class MyshareActivity extends BaseActivity {
    ...
    private void showData() {
        ...
        HttpManager.getServerApi().getshareRecord(map).enqueue(new CallBack<MyfavoritesBean>() {
            @Override
    ...
    private void setListener() {
        ...
        adapter.setOnItemListener(new OnItemListener() {
            ...
            public void onItemLongClick(View view, final int position, boolean isPress) {
                AlertDialog dialog = new AlertDialog.Builder(MyshareActivity.this)
                        .setMessage("确定要删除记录吗")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                ...
                                map.put("ids", ids + "");
                                HttpManager.getServerApi().deleteshare(map).enqueue(new CallBack<CodeValidate>() {
                                    @Override
    ...
    @OnClick({R.id.iv_back, R.id.tv_edit, R.id.cb_checked, R.id.bt_delete, R.id.go_store})
